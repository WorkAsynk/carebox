...
import ShipperCopy from '../component/Waybill/ShipperCopy'
      ...
      {!loading && !error && order && (
        <>
          <div className='flex items-center justify-start gap-3'>
           ...
           {/* Three visible copies with per-section print buttons */}
          <div className='my-6 space-y-10'>
            <ShipperCopy order={order} formatAddress={formatAddress} packages={packages} totalActualWeight={totalActualWeight} totalVolumetricWeight={totalVolumetricWeight} invoiceNo={invoiceNo} invoiceValue={invoiceValue} ewb={ewb} id={id} documentType="Shipper Copy" />
            <ShipperCopy order={order} formatAddress={formatAddress} packages={packages} totalActualWeight={totalActualWeight} totalVolumetricWeight={totalVolumetricWeight} invoiceNo={invoiceNo} invoiceValue={invoiceValue} ewb={ewb} id={id} documentType="LM Copy" />
            <ShipperCopy order={order} formatAddress={formatAddress} packages={packages} totalActualWeight={totalActualWeight} totalVolumetricWeight={totalVolumetricWeight} invoiceNo={invoiceNo} invoiceValue={invoiceValue} ewb={ewb} id={id} documentType="Receiver Copy" /> 
          </div>
        </>
      )}
    </div>
