			...
			<div className="w-full max-w-2xl bg-white p-8 rounded-xl border border-gray-200 shadow-lg">
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					{currentStep === 3 && formData.role === 'Franchise' && (
						<div className="space-y-5">
							{/* <div className="bg-gradient-to-r from-red-50 to-white p-4 rounded-lg border border-red-100 mb-6">
								<h3 className="text-lg font-semibold text-red-800 mb-2">Step 3: Rate Chart Upload</h3>
								<p className="text-sm text-red-600">Upload or create your rate chart</p>
							</div> */}
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									>
										<div className="flex items-center space-x-3">
											...
											<div>
												<h5 className="font-semibold text-gray-800">Create Table</h5>
