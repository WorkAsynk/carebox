...
const menuItems = [
	...
	},
	{
		...
		allowedRoles: ['Admin', 'Franchise', 'Operational Manager', 'Developer'] // All authenticated users
	},
	{
		label: 'User',
		...
		children: [
			{
				label: 'Create User',
				icon: <TiUserAdd className='h-5 w-5' />,
				href: '/create-user',
				allowedRoles: ['Admin']
			},
			{
				label: 'User List',
				icon: <PiUserList className='h-5 w-5' />,
				href: '/userlist',
				allowedRoles: ['Admin']
			},
		]
		...
		children: [
			{
				...
				href: '/create-order',
				allowedRoles: ['Admin', 'Franchise', 'Developer']
			},
			{
				label: 'Order List',
				icon: <FaList className='h-5 w-5' />,
				href: '/orderlist',
				allowedRoles: ['Admin', 'Franchise', 'Operational Manager', 'Developer']
			}
		]
	},
	{
	...
	},
	{
		...
		allowedRoles: ['Admin', 'Franchise', 'Operational Manager'],
		children: [
			{ label: 'Assign Truck', icon: <FaTruck className='h-5 w-5' />, href: '/assign-truck', allowedRoles: ['Admin', 'Franchise', 'Operational Manager'] },
			{
				label: 'Truck List',
				icon: <FaList className='h-5 w-5' />,
				href: '/truck-list',
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				allowedRoles: ['Admin', 'Franchise', 'Operational Manager', 'Developer', 'Client']
			}
		]
	},
	{
		...
		children: [
			{
				...
				href: '/billing-info',
				allowedRoles: ['Admin', 'Operational Manager']
			},
			{
				label: 'Sales Billing',
				icon: <BanknotesIcon className='h-5 w-5' />,
				href: '/franchise-billing-info',
	...
	},
	{
		label: 'Delivery Boy',
		icon: <FaTruck className="w-5 h-5" />,
		allowedRoles: ['Delivery Boy'],
		children: [
			{ label: 'Create Order', icon: <IoIosCreate className='h-5 w-5' />, href: '/delivery-create-order', allowedRoles: ['Delivery Boy'] },
			{ label: 'Pickup', icon: <FaTruck className='h-5 w-5' />, href: '/pickup', allowedRoles: ['Delivery Boy'] }
		]
	},
	{
		label: 'Delivery Boy',
		icon: <IoMdBody className="w-5 h-5" />,
		allowedRoles: ['Admin', 'Franchise', 'Operational Manager'],
		children: [
			{ label: 'Assign Delivery Boy', icon: <FaTruck className='h-5 w-5' />, href: '/create-delivery', allowedRoles: ['Admin', 'Franchise', 'Operational Manager'] },
			{ label: 'Delivery Boy List', icon: <FaList className='h-5 w-5' />, href: '/truck-list', allowedRoles: ['Admin', 'Franchise', 'Operational Manager'] }
		]
	},
	{
		label: 'Settings',
	...
	return (
		<>
			...
			>
				...
				<nav className="flex flex-col mt-4 overflow-y-auto h-[calc(90vh-100px)] scrollbar-hide">
